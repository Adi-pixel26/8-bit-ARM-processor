...
REM
REM Generated by Vivado on Sat Jun 27 23:15:48 +0530 2026
...
echo "xvlog --incr --relax -prj armprocessor_tb_vlog.prj"
call xvlog  --incr --relax -prj armprocessor_tb_vlog.prj -log xvlog.log
