...
HD_PWD='D:/vivadi_projects/ARM_CPU/ARM_CPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log arm_processor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source arm_processor.tcl
